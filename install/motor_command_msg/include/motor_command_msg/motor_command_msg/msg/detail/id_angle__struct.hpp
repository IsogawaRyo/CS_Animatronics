...
struct IdAngle_
{
  ...
  explicit IdAngle_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    ...
    {
      std::fill<typename std::array<uint8_t, 10>::iterator, uint8_t>(this->ids.begin(), this->ids.end(), 0);
      std::fill<typename std::array<int32_t, 10>::iterator, int32_t>(this->angles.begin(), this->angles.end(), 0l);
    }
  }
