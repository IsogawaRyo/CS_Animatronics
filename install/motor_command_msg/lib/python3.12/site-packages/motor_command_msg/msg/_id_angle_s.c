...
bool motor_command_msg__msg__id_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * motor_command_msg__msg__id_angle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_command_msg.msg._id_angle");
  ...
  {  // ids
    ...
    memcpy(dst, src, 76800 * sizeof(uint8_t));
    Py_DECREF(field);
  }
  {  // angles
    PyObject * field = NULL;
    ...
    memcpy(dst, src, 76800 * sizeof(int32_t));
    Py_DECREF(field);
  }
