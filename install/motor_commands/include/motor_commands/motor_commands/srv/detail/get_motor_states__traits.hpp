  ...
  std::ostream & out)
{
  ...
  {
    out << "port0_total_current: ";
    rosidl_generator_traits::value_to_yaml(msg.port0_total_current, out);
    out << ", ";
  }

  // member: port1_total_current
  {
    out << "port1_total_current: ";
    rosidl_generator_traits::value_to_yaml(msg.port1_total_current, out);
    out << ", ";
  }

  // member: system_total_current
  {
    out << "system_total_current: ";
    rosidl_generator_traits::value_to_yaml(msg.system_total_current, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)
