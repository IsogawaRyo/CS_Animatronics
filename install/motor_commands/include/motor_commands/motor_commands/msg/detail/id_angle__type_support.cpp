...
{
  new (message_memory) motor_commands::msg::IdAngle(_init);
}

void IdAngle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<motor_commands::msg::IdAngle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IdAngle_message_member_array[2] = {
  {
    ...
    offsetof(motor_commands::msg::IdAngle, ids),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_commands::msg::IdAngle, angles),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IdAngle_message_members = {
  "motor_commands::msg",  // message namespace
  "IdAngle",  // message name
  2,  // number of fields
  sizeof(motor_commands::msg::IdAngle),
...
{
  return &::motor_commands::msg::rosidl_typesupport_introspection_cpp::IdAngle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_commands, msg, IdAngle)() {
  return &::motor_commands::msg::rosidl_typesupport_introspection_cpp::IdAngle_message_type_support_handle;
}
