...
#include "motor_command_msg/msg/detail/id_angle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motor_command_msg::msg::IdAngle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const motor_command_msg::msg::IdAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_command_msg::msg::IdAngle *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_motor_command_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<motor_command_msg::msg::IdAngle>()
{
  return &motor_command_msg::msg::typesupport_fastrtps_cpp::_IdAngle__handle;
}
