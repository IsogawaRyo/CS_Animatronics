...
#include "motor_commands/msg/detail/id_angle__rosidl_typesupport_fastrtps_c.h"
...
using _IdAngle__ros_msg_type = motor_commands__msg__IdAngle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motor_commands__msg__IdAngle;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const motor_commands__msg__IdAngle * ros_message = static_cast<const motor_commands__msg__IdAngle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_motor_commands__msg__IdAngle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  motor_commands__msg__IdAngle * ros_message = static_cast<motor_commands__msg__IdAngle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_motor_commands__msg__IdAngle(cdr, ros_message);
}

static uint32_t _IdAngle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_motor_commands__msg__IdAngle(
...
static size_t _IdAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_motor_commands__msg__IdAngle(
