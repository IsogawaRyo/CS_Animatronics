...
size_t size_function__GetMotorStates_Response__error_status(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return member->size();
}

const void * get_const_function__GetMotorStates_Response__error_status(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__GetMotorStates_Response__error_status(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__GetMotorStates_Response__error_status(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__GetMotorStates_Response__error_status(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__GetMotorStates_Response__error_status(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__GetMotorStates_Response__error_status(untyped_member, index));
  const auto & value = *reinterpret_cast<const std::string *>(untyped_value);
  item = value;
}

void resize_function__GetMotorStates_Response__error_status(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetMotorStates_Response_message_member_array[8] = {
  {
    "ids",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_UINT8,  // type
    0,  // upper bound of string
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_commands::srv::GetMotorStates_Response, error_status),  // bytes offset in struct
    nullptr,  // default value
    size_function__GetMotorStates_Response__error_status,  // size() function pointer
    get_const_function__GetMotorStates_Response__error_status,  // get_const(index) function pointer
    get_function__GetMotorStates_Response__error_status,  // get(index) function pointer
    fetch_function__GetMotorStates_Response__error_status,  // fetch(index, &value) function pointer
    assign_function__GetMotorStates_Response__error_status,  // assign(index, value) function pointer
    resize_function__GetMotorStates_Response__error_status  // resize(index) function pointer
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_commands::srv::GetMotorStates_Response, port0_total_current),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_commands::srv::GetMotorStates_Response, port1_total_current),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_commands::srv::GetMotorStates_Response, system_total_current),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
